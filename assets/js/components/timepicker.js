...
(function(addon) {
    ...
    UI.component('timepicker', {
        ...
        boot: function() {
            ...
            // init code
            UI.$html.on('focus.timepicker.uikit', '[data-sb-timepicker]', function(e) {

                var ele = UI.$(this);

                if (!ele.data('timepicker')) {
                    var obj = UI.timepicker(ele, UI.Utils.options(ele.attr('data-sb-timepicker')));
        ...
        init: function() {
            ...
            this.options.template  = '<ul class="sb-nav sb-nav-autocomplete sb-autocomplete-results">{{~items}}<li data-value="{{$item.value}}"><a>{{$item.value}}</a></li>{{/items}}</ul>';
            ...
            if (this.element.is('input')) {
                this.element.wrap('<div class="sb-autocomplete"></div>');
                container = this.element.parent();
            } else {
                container = this.element.addClass('sb-autocomplete');
            }

            this.autocomplete = UI.autocomplete(container, this.options);
            this.autocomplete.dropdown.addClass('sb-dropdown-small sb-dropdown-scrollable');

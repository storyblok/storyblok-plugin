...
(function(addon) {
    ...
    UI.component('sortable', {
        ...
        defaults: {
            ...
            childClass       : 'sb-sortable-item',
            placeholderClass : 'sb-sortable-placeholder',
            overClass        : 'sb-sortable-over',
            draggingClass    : 'sb-sortable-dragged',
            dragMovingClass  : 'sb-sortable-moving',
            baseClass        : 'sb-sortable',
            noDragClass      : 'sb-sortable-nodrag',
            emptyClass       : 'sb-sortable-empty',
            dragCustomClass  : '',
            handleClass      : false,
            group            : false,
        ...
        boot: function() {
            ...
            UI.ready(function(context) {
                ...
                UI.$('[data-sb-sortable]', context).each(function(){

                    var ele = UI.$(this);

                    if(!ele.data('sortable')) {
                        UI.sortable(ele, UI.Utils.options(ele.attr('data-sb-sortable')));
                    }
                });
            });

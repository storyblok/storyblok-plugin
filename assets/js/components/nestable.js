...
(function(addon) {
    ...
    UI.component('nestable', {
        ...
        defaults: {
            listBaseClass   : 'sb-nestable',
            listClass       : 'sb-nestable-list',
            listItemClass   : 'sb-nestable-item',
            dragClass       : 'sb-nestable-dragged',
            movingClass     : 'sb-nestable-moving',
            noChildrenClass : 'sb-nestable-nochildren',
            emptyClass      : 'sb-nestable-empty',
            handleClass     : '',
            collapsedClass  : 'sb-collapsed',
            placeholderClass: 'sb-nestable-placeholder',
            noDragClass     : 'sb-nestable-nodrag',
            group           : false,
            maxDepth        : 10,
            threshold       : 20,
            idlethreshold   : 10,
        ...
        boot: function() {
            ...
            UI.ready(function(context) {
                ...
                UI.$("[data-sb-nestable]", context).each(function(){

                    var ele = UI.$(this);

                    if (!ele.data("nestable")) {
                        UI.nestable(ele, UI.Utils.options(ele.attr("data-sb-nestable")));
                    }
                });
            });
        },
        ...
        setParent: function(li) {
            ...
            if (li.children(this.options._listClass).length) {
                li.addClass('sb-parent');
            }
        },

        unsetParent: function(li) {
            li.removeClass('sb-parent '+this.options.collapsedClass);
